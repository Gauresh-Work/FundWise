...
const resources = {
  ...
  folios: {
    ...
    fields: [ref('investorId', 'Investor', 'investors', 'fullName'), ref('schemeId', 'Scheme', 'schemes', 'name'), field('folioNumber', 'Folio number', 'text', true), select('status', 'Status', ['ACTIVE', 'FROZEN', 'CLOSED'], true), field('currentUnits', 'Current units', 'number', true, { min: 0, step: .0001 }), field('averageNav', 'Average NAV', 'number', true, { min: 0, step: .0001 }), field('currentValue', 'Current value', 'number', true, { min: 0, step: .01 })],
