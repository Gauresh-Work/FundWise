...
@RestControllerAdvice public class ApiExceptionHandler {
 ...
 @ExceptionHandler(DataIntegrityViolationException.class) @ResponseStatus(HttpStatus.CONFLICT) public Map<String,Object> duplicate(){return Map.of("timestamp",Instant.now(),"status",409,"message","A scheme with this code already exists");}
}
