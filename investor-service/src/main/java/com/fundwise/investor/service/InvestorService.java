...
public class InvestorService {
    ...
    public KycDocument createKycDocument(KycDocumentRequest request) { validateDocument(request); return kycDocumentRepository.save(kycDocument(request)); }
    ...
    public KycDocument updateKycDocument(Long id, KycDocumentRequest request) { validateDocument(request); KycDocument entity = getKycDocument(id); copy(request, entity); return kycDocumentRepository.save(entity); }
